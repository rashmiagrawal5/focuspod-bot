...
const MESSAGES = {
  ...
  WELCOME_NEW_USER_PAID: "Hi! 👋 Welcome to FocusPod. Let's get you booked into a quiet pod! 🎉",
  ...
  WELCOME_EXISTING_FIRST_TIME_PAID: (name) => `Hi ${name}! 👋 Welcome back to FocusPod. Let's get you booked! 🎉`,
